...
function History() {
  ...
  <img src="/public/img/dinelogo.svg" alt="Dine logosu" />
...
function Footer() {
  return (
    ...
    <img className="dere"  src="/public/img/dere.png" alt="dere fotoğrafi" />
    <img className="deretablet"  src="/public/img/deretablet.png" alt="dere tablet" />
    <img className="deremobil"   src="/public/img/mobildere.png" alt="dere mobil" />
    <div className="footer-inform">
      <img  className="design" src="/public/img/yuvarlakcizgi.svg" alt="yuvarlak ve bir çizgiden oluşan şema" />
...
function FoodPromotion() {
  return (
    ...
    <div className="footer-inform">
      <img  class="design" src="/public/img/yuvarlakcizgi.svg" alt="yuvarlak ve bir çizgiden oluşan şema" />
    ...
    <img className="asci"  src="/public/img/ascieli.png" alt="Aşçının elinin gözüktüğü yemek fotoğrafı" />
    <img className="ascitablet" src="/public/img/tabletasci.png" alt="Aşçı tablet " />
    <img className="ascimobil" src="/public/img/mobilasci.png" alt="Aşçı mobil" />
  </div>
  )
}
...
function Menu() {
  return (
    ...
    <div className="menu-item">
      <div className="item">
        <img src="/public/img/somon.png" alt="Somon porsiyon fotoğrafı" />
      ...
      <div className="item">
        <img src="/public/img/yurvarlaket.png" alt="Yuvarlak şekilde pişirilmiş et fotoğrafı" />
        <div className="item-writes">
      ...
      <div className="item">
        <img src="/public/img/tatlı.png" alt="Mug fotoğrafı" />
        <div className="item-writes">
...
function Nav() {
  return (
    <div class="nav">
    <img src="/public/img/dinelogo.svg" alt="Dine logo" />
    <div class="nav-item">
      <ol>
